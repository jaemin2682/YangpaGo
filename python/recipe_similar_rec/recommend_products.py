...
def main():
    ...
    print("========================================스토어 상품 추천=========================================================")
    if(get_user_behavior_data_by_seller("average10@naver.com") is not 0):
        df_svd_preds, df_products, df_ratings, user_id_index = get_user_behavior_data_by_seller("average10@naver.com")
